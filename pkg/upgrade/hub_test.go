...
func TestInfo(t *testing.T) {
	const input = `{"size": 0, "name": "test:development:latest.flist", "target": "test:development:0.2.0.flist", "type": "symlink", "updated": 1569924782, "md5": "9798ef9b930b49ab18c45953cf1d2369"}`
