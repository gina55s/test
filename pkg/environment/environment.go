...
const (
	baseExtendedURL = "https://raw.githubusercontent.com/threefoldtech/test-config/main/"
)
...
type Environment struct {
	...
	// if set, test will use this as its priv vlan
	PrivVlan *uint16

	// pub vlan to join
	// if set, test will use this as it's pub vlan
