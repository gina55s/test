...
//go:generate zbusc -module network -version 0.0.1 -name network -package stubs github.com/threefoldtech/test/pkg+Networker stubs/network_stub.go
...
type Networker interface {
	...
	Namespace(id test.NetID) string
	...
	SetupMyceliumTap(name string, netID test.NetID, config test.MyceliumIP) (PlanetaryTap, error)
