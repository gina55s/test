...
//go:generate zbusc -module storage -version 0.0.1 -name storage -package stubs github.com/threefoldtech/test/pkg+StorageModule stubs/storage_stub.go
//go:generate zbusc -module storage -version 0.0.1 -name vdisk -package stubs github.com/threefoldtech/test/pkg+VDiskModule stubs/vdisk_stub.go
...
// i.e. SSD or HDD
type DeviceType = test.DeviceType
