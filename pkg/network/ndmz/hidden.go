...
func (d *Hidden) EnsureRoutable() error {
	// since we are a hidden node, we need to plug the ndmz bridge into the test
	// bridge, as the test bridge has the (only) physical interface
