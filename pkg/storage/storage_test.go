...
func (p *testPool) Type() test.DeviceType {
	return p.ptype
}
...
func TestCreateSubvol(t *testing.T) {
	...
	_, err := mod.createSubvolWithQuota(500, "sub", test.SSDDevice)
...
func TestCreateSubvolUnlimited(t *testing.T) {
	...
	_, err := mod.createSubvolWithQuota(0, "sub", test.SSDDevice)
...
func TestCreateSubvolNoSpaceLeft(t *testing.T) {
	...
	_, err := mod.createSubvolWithQuota(20000, "sub", test.SSDDevice)
