...
`
	fsString2 = `Label: 'sp_test-cache'  uuid: e8784776-6288-49e2-9cb0-29e50707bd73
...
`
	...
	Label: 'sp_test-cache'  uuid: c739f6f4-a02b-429c-9ffa-7899b65ad566
...
func TestParseFSWithWarnings(t *testing.T) {
	...
	fs := fss[0]
	assert.Nil(t, err)
	assert.Equal(t, "sp_test-cache", fs.Label)
