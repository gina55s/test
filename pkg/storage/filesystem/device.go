...
type DeviceManager interface {
	...
	Seektime(ctx context.Context, device string) (test.DeviceType, error)
}
...
func (d *DeviceInfo) DetectType() (test.DeviceType, error) {
...
func (l *lsblkDeviceManager) Seektime(ctx context.Context, device string) (test.DeviceType, error) {
	...
	return test.DeviceType(strings.ToLower(result.Type)), nil
}
