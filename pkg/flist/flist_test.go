...
func TestMountUnmount(t *testing.T) {
	...
	strg.On("CreateFilesystem", mock.Anything, uint64(256*mib), test.SSDDevice).
...
func TestIsolation(t *testing.T) {
	...
	strg.On("CreateFilesystem", mock.Anything, mock.Anything, mock.Anything, uint64(256*mib), test.SSDDevice).
		Return("/my/backend", nil)
