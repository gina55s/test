...
// RegisterType register a new workload type. This is used by test to "declare"
// the workload types it supports. please check `test` sub package for all
// supported types.
// Note: a user never need to call this, it's done by test libraries.
