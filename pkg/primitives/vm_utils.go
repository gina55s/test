...
func (p *Primitives) newPrivNetworkInterface(ctx context.Context, dl gridtypes.Deployment, wl *gridtypes.WorkloadWithID, inf test.MachineInterface) (pkg.VMIface, error) {
	network := stubs.NewNetworkerStub(p.zbus)
...
func (p *Primitives) getPubIPConfig(wl *gridtypes.WorkloadWithID) (result test.PublicIPResult, err error) {
