...
func (p *Manager) vmMounts(ctx context.Context, deployment gridtypes.Deployment, mounts []test.MachineMount, format bool, vm *pkg.VM) error {
...
func (p *Manager) mountDisk(ctx context.Context, wl *gridtypes.WorkloadWithID, mount test.MachineMount, format bool, vm *pkg.VM) error {
...
func (p *Manager) mountQsfs(wl *gridtypes.WorkloadWithID, mount test.MachineMount, vm *pkg.VM) error {
...
func (p *Manager) virtualMachineProvisionImpl(ctx context.Context, wl *gridtypes.WorkloadWithID) (result test.ZMachineResult, err error) {
	var (
		storage = stubs.NewStorageModuleStub(p.zbus)
