...
func (p *Primitives) mountsToDisks(ctx context.Context, deployment gridtypes.Deployment, disks []test.MachineMount, format bool) ([]pkg.VMDisk, error) {
	...
	for _, disk := range disks {
		...
		if wl.Type != test.ZMountType {
			return nil, fmt.Errorf("expecting a reservation of type '%s' for disk '%s'", test.ZMountType, disk.Name)
		}
