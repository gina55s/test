...
func (p *Manager) zdbProvisionImpl(ctx context.Context, wl *gridtypes.WorkloadWithID) (test.ZDBResult, error) {
	var (
		//contmod = stubs.NewContainerModuleStub(p.zbus)
...
func (p *Manager) zdbUpdateImpl(ctx context.Context, wl *gridtypes.WorkloadWithID) (result test.ZDBResult, err error) {
