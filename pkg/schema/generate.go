...
var (
	...
	goKindMap = map[Kind][2]string{
		...
		BoolKind:      {"", "bool"},
		BytesKind:     {"", "[]byte"},
		DateKind:      {"github.com/threefoldtech/test/pkg/schema", "Date"},
		DateTimeKind:  {"github.com/threefoldtech/test/pkg/schema", "Date"},
		NumericKind:   {"github.com/threefoldtech/test/pkg/schema", "Numeric"},
		IPAddressKind: {"net", "IP"},
		IPRangeKind:   {"github.com/threefoldtech/test/pkg/schema", "IPRange"},
