...
func (s *StorageModuleStub) Allocate(arg0 string, arg1 test.DeviceType, arg2 uint64, arg3 test.ZDBMode) (ret0 pkg.Allocation, ret1 error) {
...
func (s *StorageModuleStub) CreateFilesystem(arg0 string, arg1 uint64, arg2 test.DeviceType) (ret0 pkg.Filesystem, ret1 error) {
...
func (s *StorageModuleStub) Total(arg0 test.DeviceType) (ret0 uint64, ret1 error) {
	args := []interface{}{arg0}
