...
func (s *QSFSDStub) Mount(ctx context.Context, arg0 string, arg1 test.QuantumSafeFS) (ret0 pkg.QSFSInfo, ret1 error) {
...
func (s *QSFSDStub) UpdateMount(ctx context.Context, arg0 string, arg1 test.QuantumSafeFS) (ret0 pkg.QSFSInfo, ret1 error) {
	args := []interface{}{arg0, arg1}
