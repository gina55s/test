...
func (s *NetworkerStub) GetDefaultGwIP(ctx context.Context, arg0 test.NetID) (ret0 []uint8, ret1 []uint8, ret2 error) {
	args := []interface{}{arg0}
...
func (s *NetworkerStub) GetIPv6From4(ctx context.Context, arg0 test.NetID, arg1 []uint8) (ret0 net.IPNet, ret1 error) {
	args := []interface{}{arg0, arg1}
...
func (s *NetworkerStub) GetNet(ctx context.Context, arg0 test.NetID) (ret0 net.IPNet, ret1 error) {
	args := []interface{}{arg0}
...
func (s *NetworkerStub) GetSubnet(ctx context.Context, arg0 test.NetID) (ret0 net.IPNet, ret1 error) {
	args := []interface{}{arg0}
...
func (s *NetworkerStub) Join(ctx context.Context, arg0 test.NetID, arg1 string, arg2 pkg.ContainerNetworkConfig) (ret0 pkg.Member, ret1 error) {
...
func (s *NetworkerStub) Leave(ctx context.Context, arg0 test.NetID, arg1 string) (ret0 error) {
	args := []interface{}{arg0, arg1}
...
func (s *NetworkerStub) RemoveTap(ctx context.Context, arg0 test.NetID) (ret0 error) {
	args := []interface{}{arg0}
...
func (s *NetworkerStub) SetupTap(ctx context.Context, arg0 test.NetID) (ret0 string, ret1 error) {
	args := []interface{}{arg0}
...
func (s *NetworkerStub) TapExists(ctx context.Context, arg0 test.NetID) (ret0 bool, ret1 error) {
	args := []interface{}{arg0}
