...
func (s *NetworkerStub) Namespace(ctx context.Context, arg0 test.NetID) (ret0 string) {
	args := []interface{}{arg0}
...
func (s *NetworkerStub) SetupMyceliumTap(ctx context.Context, arg0 string, arg1 test.NetID, arg2 test.MyceliumIP) (ret0 pkg.PlanetaryTap, ret1 error) {
...
func (s *NetworkerStub) SetupPrivTap(ctx context.Context, arg0 test.NetID, arg1 string) (ret0 string, ret1 error) {
	args := []interface{}{arg0, arg1}
