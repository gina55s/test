...
func (s *NetworkerStub) GetDefaultGwIP(arg0 test.NetID) (ret0 []uint8, ret1 []uint8, ret2 error) {
	args := []interface{}{arg0}
...
func (s *NetworkerStub) GetIPv6From4(arg0 test.NetID, arg1 []uint8) (ret0 net.IPNet, ret1 error) {
	args := []interface{}{arg0, arg1}
...
func (s *NetworkerStub) GetNet(arg0 test.NetID) (ret0 net.IPNet, ret1 error) {
	args := []interface{}{arg0}
...
func (s *NetworkerStub) GetSubnet(arg0 test.NetID) (ret0 net.IPNet, ret1 error) {
	args := []interface{}{arg0}
...
func (s *NetworkerStub) Join(arg0 test.NetID, arg1 string, arg2 pkg.ContainerNetworkConfig) (ret0 pkg.Member, ret1 error) {
...
func (s *NetworkerStub) Leave(arg0 test.NetID, arg1 string) (ret0 error) {
	args := []interface{}{arg0, arg1}
...
func (s *NetworkerStub) RemoveTap(arg0 test.NetID) (ret0 error) {
	args := []interface{}{arg0}
...
func (s *NetworkerStub) SetupTap(arg0 test.NetID) (ret0 string, ret1 error) {
	args := []interface{}{arg0}
...
func (s *NetworkerStub) TapExists(arg0 test.NetID) (ret0 bool, ret1 error) {
	args := []interface{}{arg0}
