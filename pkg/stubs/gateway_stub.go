...
func (s *GatewayStub) SetFQDNProxy(ctx context.Context, arg0 string, arg1 test.GatewayFQDNProxy) (ret0 error) {
...
func (s *GatewayStub) SetNamedProxy(ctx context.Context, arg0 string, arg1 test.GatewayNameProxy) (ret0 string, ret1 error) {
	args := []interface{}{arg0, arg1}
