...
func setQSFSDefaults(cfg *test.QuantumSafeFS) zstorConfig {
	return zstorConfig{
...
func (q *QSFS) Mount(wlID string, cfg test.QuantumSafeFS) (info pkg.QSFSInfo, err error) {
	defer func() {
		if err != nil {
			q.Unmount(wlID)
		}
...
func (q *QSFS) UpdateMount(wlID string, cfg test.QuantumSafeFS) (pkg.QSFSInfo, error) {
