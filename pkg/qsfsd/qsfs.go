...
func (q *QSFS) Mount(wlID string, cfg test.QuatumSafeFS) (mountPath string, err error) {
	defer func() {
		if err != nil {
...
func (q *QSFS) writeQSFSConfig(root string, cfg test.QuantumSafeFSConfig) error {
