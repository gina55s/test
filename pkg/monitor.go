...
//go:generate zbusc -module node -version 0.0.1 -name system -package stubs github.com/threefoldtech/test/pkg+SystemMonitor stubs/system_monitor_stub.go
//go:generate zbusc -module node -version 0.0.1 -name host -package stubs github.com/threefoldtech/test/pkg+HostMonitor stubs/host_monitor_stub.go
