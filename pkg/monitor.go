...
//go:generate zbusc -module monitor -version 0.0.1 -name system -package stubs github.com/threefoldtech/test/pkg+SystemMonitor stubs/system_monitor_stub.go
//go:generate zbusc -module monitor -version 0.0.1 -name host -package stubs github.com/threefoldtech/test/pkg+HostMonitor stubs/host_monitor_stub.go
//go:generate zbusc -module identityd -version 0.0.1 -name monitor -package stubs github.com/threefoldtech/test/pkg+VersionMonitor stubs/version_monitor_stub.go
//go:generate zbusc -module provision -version 0.0.1 -name provision -package stubs github.com/threefoldtech/test/pkg+ProvisionMonitor stubs/provision_monitor_stub.go
