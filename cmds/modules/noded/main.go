...
import (
	...
	"github.com/threefoldtech/test/pkg/perf/healthcheck"
	"github.com/threefoldtech/test/pkg/perf/iperf"
	"github.com/threefoldtech/test/pkg/perf/networkhealth"
...
func action(cli *cli.Context) error {
	...
	bus.WithHandler("test.system.version", func(ctx context.Context, payload []byte) (interface{}, error) {
	...
	bus.WithHandler("test.system.diagnostics", func(ctx context.Context, payload []byte) (interface{}, error) {
	...
	bus.WithHandler("test.perf.get", func(ctx context.Context, payload []byte) (interface{}, error) {
		type Payload struct {
			Name string
		}
		var request Payload
	...
	bus.WithHandler("test.perf.get_all", func(ctx context.Context, payload []byte) (interface{}, error) {
