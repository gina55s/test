...
import (
	...
	"github.com/threefoldtech/test/tools/test-update-version/internal"
)

var rootCmd = &cobra.Command{
	Use:   "test-update-version",
	Short: "A worker to update the version of test",
...
func init() {
	...
	rootCmd.Flags().StringP("dst", "d", "tf-test", "Enter your destination directory")
